        ...
        btnsignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void signup() {
                ...
                if (TextUtils.isEmpty(username)) {
                    ...
                    if (addAccount(username, password, email)) {
                        ...
                        Intent intent = new Intent(SignUp_Teacher.this, LecturerLogin.class);
            ...
            private boolean isUsernameExists(String username) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(SignUp_Teacher.this, "Lỗi truy vấn cơ sở dữ liệu!", Toast.LENGTH_SHORT).show();
                }
                return check;
            }
            ...
            private boolean addAccount(String username, String password, String email) {
                try {
                    String query = "INSERT INTO giangvien (username, password, email) VALUES (?, ?, ?)";
                    PreparedStatement ps = connect.prepareStatement(query);
                    ps.setString(1, username);
